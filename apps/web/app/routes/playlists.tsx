...
import { Plus, Disc3, Settings, Trash2, CheckSquare, Square, X } from "lucide-react";
...
export default function Playlists() {
  ...
  const { playlists, addPlaylist, removePlaylist, removePlaylists, updatePlaylist } = usePlaylistStore();
